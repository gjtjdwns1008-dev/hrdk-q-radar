...
def run_ai_analysis(law, qnet_certs_text, attempt_count=5):
    ...
    ### 📈 [STEP 3. 노동시장 활용도 (연관높음일 때만, 아니면 빈칸)]
    ...
    * Ⅳ-0 (제외): 타 조문 통합·삭제·이관, 정의 조항, 우대 외 사항
    ...
    {{
      ...
      "활용도_구분": "대폭 증가/소폭 증가/현상 유지/소폭 감소/대폭 감소 중 택1 (연관높음 아닐 땐 \\"\\")",
      "활용도_상세": "자격 수요·활용도 분석 3문장 이내 (연관높음 아닐 땐 \\"\\")",
      "우대여부": "O" | "X",
    ...
    try:
        ...
        활용도_구분 = _normalize_usage(data.get("활용도_구분", "")) if 연관도 == "연관높음" else ""
        ...
        law_info = {
            ...
            "활용도_구분": 활용도_구분,
            "활용도_상세": data.get("활용도_상세", "") if 연관도 == "연관높음" else "",
